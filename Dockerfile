...
RUN apt update && DEBIAN_FRONTEND=noninteractive apt install -y zlib1g-dev libpng-dev libc-client-dev libkrb5-dev libicu-dev libpcre3-dev libcurl4-openssl-dev wget jq libldap2-dev libxml2 libxml2-dev libxpm-dev libxslt1-dev libxslt1-dev && rm -r /var/lib/apt/lists/*
